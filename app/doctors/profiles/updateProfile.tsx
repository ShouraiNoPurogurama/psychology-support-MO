    ...
    const fetchDoctorInfo = async () => {
      try {
        ...
        if (!imageResponse.ok) {
          ...
          setAvatarUrl(null); // Sử dụng ảnh mặc định nếu không tìm thấy avatar
        } else {
  ...
  const pickImage = async () => {
    try {
      let result = await ImagePicker.launchImageLibraryAsync({
        mediaTypes: ImagePicker.MediaTypeOptions.Images, // Corrected API usage
        allowsEditing: true,
        aspect: [1, 1],
        quality: 1,
      });
        ...
        <View style={styles.profileContainer}>
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setDoctor({ ...doctor, yearsOfExperience: text })
              }
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setDoctor({
                  ...doctor,
                  contactInfo: { ...doctor.contactInfo, email: text },
                })
              }
            />
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setDoctor({
                  ...doctor,
                  contactInfo: { ...doctor.contactInfo, phoneNumber: text },
                })
              }
            />
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setDoctor({
                  ...doctor,
                  contactInfo: { ...doctor.contactInfo, address: text },
                })
              }
            />
          </View>
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setDoctor({ ...doctor, qualifications: text })
              }
            />
          </View>
